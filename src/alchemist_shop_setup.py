...
def alchemist_shop_setup():
	...
	action('EnableIcon(Inspect, magnifyingglass, Alch.RightBookcase, Browse, false)')
	action('EnableIcon(Inspect, magnifyingglass, Alch.LeftBookcase, Browse, false)')
	action('EnableIcon(Inspect, magnifyingglass, Alch.Cauldron, Inspect, false)')
