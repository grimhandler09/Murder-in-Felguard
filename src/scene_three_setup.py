...
def scene_three_setup():
	...
	action('EnableIcon(Inspect, magnifyingglass, Alch.RightBookcase)')
	action('EnableIcon(Inspect, magnifyingglass, Alch.LeftBookcase)')
	action('EnableIcon(Inspect, magnifyingglass, Alch.Cauldron)')
